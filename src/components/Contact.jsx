...
function Contact() {
  ...
  return (
    <div
      ref={contactRef}
      className="contactPage min-h-[60vh] flex flex-col justify-center w-screen px-5 sm:px-10 py-10"
    >
      <div className="head h-[10vh] w-full my-[5vh]">
      ...
      <div className="min-h-[70vh] form-con w-full flex items-center justify-center">
